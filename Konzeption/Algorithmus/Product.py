class Product(object):
    ...
    def init(self, product_ID, sellPrice, recipe_ID):
...
class ProductStorage(object):
    ...
    def init(self, stock, capacity, output, product_ID, costsPerUnit):
        self.stock = stock
...
class Recipe(object):
    ...
    def init(self, recipe_ID: int, steps: int, product_ID: int):
        self.recipe_ID = recipe_ID
        self.steps = steps
        self.product_ID = product_ID
...
class Step(object):
    ...
    def init(self, step_ID: int, name):
